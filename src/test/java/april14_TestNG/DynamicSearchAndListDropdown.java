...
public class DynamicSearchAndListDropdown {
	...
	@Test(priority=1)
	public void dynamicSearchAndListDropdrown() throws InterruptedException 
	{
		WebElement searchBox = driver.findElement(By.id("twotabsearchtextbox"));
		searchBox.sendKeys("sungless");
		...
		for(int i=0; i<=dynamicList.size(); i++) 
		{
			...
			if(dynamicList.get(i).getText().contains("for men")) 
			{
	...
	@Test(priority=2)
	public void dynamicSearchAndList_Example2() throws InterruptedException 
	{
		WebElement searchBox = driver.findElement(By.id("twotabsearchtextbox"));
		searchBox.sendKeys("sunglass");
		Thread.sleep(1000);
		List<WebElement> dynamicList = driver.findElements(By.xpath("//span[@class='s-heavy']"));
